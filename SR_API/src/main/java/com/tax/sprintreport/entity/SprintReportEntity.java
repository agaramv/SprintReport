...
public class SprintReportEntity {
	...
	public SprintReportEntity(SprintReportEntityKey sprintReportEntitykey, LocalDate sprintStartdate,
			...
			int supportInd, int improvement, int newValueInd, int runInd, int growInd, int transformInd,
			int sprintCapacity, int planned_capacity, int actualCapacity, int estimatedHours, int completedHours,
			LocalDateTime createDate, LocalDateTime lastUpdDate) {
		super();
