package com.tax.sprintreport.config;
...
@EnableJpaRepositories(basePackages = "com.tax.sprintreport", entityManagerFactoryRef = "entityManager", transactionManagerRef = "transactionManager")
