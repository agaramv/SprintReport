...
INSERT INTO `r_ot_request` VALUES ('ITR','123458','Test3','Test1','A'),('OTR','123456','Test1','Test1','A'),('OTR','123457','Test2','Test1','A');
...
INSERT INTO `r_scrum_master` VALUES ('vagaram09@gmail.com','Vidur Agaram'),('vagaram@gmail.com','Vengatesh Agaram');
...
CREATE TABLE `sprint_report` (
  ...
  `sprint_num` int(11) NOT NULL,
  `sprint_start_date` date NOT NULL,
  `sprint_end_date` date NOT NULL,
  `scrum_master_email` varchar(45) DEFAULT 'test@gmail.com',
  `planned_PBI_completed` int(11) DEFAULT NULL,
  `planned_PBI_not_completed` int(11) DEFAULT NULL,
  `planned_bug_completed` int(11) DEFAULT '0',
  `planned_bug_not_completed` int(11) DEFAULT '0',
  `Addon_PBI_completed` int(11) DEFAULT NULL,
  `Addon_PBI_not_completed` int(11) DEFAULT NULL,
  `Addon_bug_completed` int(11) DEFAULT NULL,
  `Addon_bug_not_completed` int(11) DEFAULT NULL,
  ...
  `improvement` int(11) DEFAULT '0',
  `new_value` int(11) DEFAULT '0',
  `run_ind` int(11) DEFAULT '0',
  `grow_ind` int(11) DEFAULT '0',
  `transform_ind` int(11) DEFAULT '0',
  `sprint_capacity` int(11) DEFAULT '0',
...
-- Dump completed on 2020-05-18 16:11:22
